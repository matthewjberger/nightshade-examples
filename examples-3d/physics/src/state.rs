...
impl State for PhysicsGame {
    ...
    fn run_systems(&mut self, world: &mut World) {
        let dt = world.resources.window.timing.delta_time.min(1.0 / 30.0);
        world.resources.physics.fixed_timestep = dt;
        world.resources.physics.integration_parameters.dt = dt;

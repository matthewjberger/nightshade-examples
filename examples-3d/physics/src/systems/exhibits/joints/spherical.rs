use crate::ecs::{GameWorld, SPHERICAL_JOINT_VISUAL, SphericalJointVisual};
...
pub(crate) fn spawn_spherical_joint_exhibit(
    ...
    let pendulum_material = create_textured_material(nalgebra_glm::vec3(0.3, 0.8, 0.3), 0.5, 0.3);

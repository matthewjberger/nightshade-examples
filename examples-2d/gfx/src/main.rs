...
impl GfxDemo {
    ...
    fn build_fill_and_stroke(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(fill_circle) {
            sprite.depth = 4.1;
        }
        if let Some(sprite) = world.get_sprite_mut(stroke_circle) {
            sprite.depth = 4.0;
        }
        ...
        if let Some(sprite) = world.get_sprite_mut(fill_rect) {
            sprite.depth = 4.1;
        }
        if let Some(sprite) = world.get_sprite_mut(stroke_rect) {
            sprite.depth = 4.0;
        }
        ...
        if let Some(sprite) = world.get_sprite_mut(fill_circle_b) {
            sprite.depth = 4.1;
        }
        if let Some(sprite) = world.get_sprite_mut(stroke_circle_b) {
            sprite.depth = 4.0;
        }
    ...
    fn build_screen_blend(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(background) {
            sprite.depth = 3.0;
        }
    ...
    fn build_polygons(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(star_entity) {
            sprite.depth = 4.0;
        }
        ...
        if let Some(sprite) = world.get_sprite_mut(hex_entity) {
            sprite.depth = 4.0;
        }
    ...
    fn build_fill_stroke_ellipse(&mut self, world: &mut World) {
            ...
            configs.iter().enumerate()
        {
            ...
            if let Some(sprite) = world.get_sprite_mut(fill_entity) {
                sprite.depth = 4.1 - index as f32 * 0.01;
            }
            if let Some(sprite) = world.get_sprite_mut(stroke_entity) {
    ...
    fn build_clip_rects(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(border_entity) {
            sprite.depth = 3.5;
        }
    ...
    fn build_shadow_demo(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(circle_entity) {

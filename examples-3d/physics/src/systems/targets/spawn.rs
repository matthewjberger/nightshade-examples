...
pub(crate) fn spawn_targets(game_world: &mut GameWorld, world: &mut World) {
    let targets: &[(Vec3, Vec3, f32, f32, &str)] = &[
        (
            nalgebra_glm::vec3(-6.0, 3.0, -6.0),
            nalgebra_glm::vec3(0.9, 0.3, 0.3),
            0.25,
            3.0,
            "Sphere",
        ),
        (
            nalgebra_glm::vec3(6.0, 4.5, -6.0),
            nalgebra_glm::vec3(0.3, 0.9, 0.3),
            0.3,
            5.0,
            "Sphere",
        ),
        (
            nalgebra_glm::vec3(0.0, 5.0, -10.0),
            nalgebra_glm::vec3(0.3, 0.5, 0.9),
            0.4,
            8.0,
            "Cube",
        ),
        (
            nalgebra_glm::vec3(-8.0, 2.5, 0.0),
            nalgebra_glm::vec3(0.9, 0.7, 0.2),
            0.2,
            2.0,
            "Sphere",
        ),
        (
            ...
            nalgebra_glm::vec3(0.7, 0.3, 0.9),
            0.35,
            6.0,
            "Cube",
        ),
        (
            nalgebra_glm::vec3(-3.0, 6.0, -3.0),
            nalgebra_glm::vec3(0.2, 0.8, 0.8),
            0.2,
            2.0,
            "Sphere",
        ),
        (
            nalgebra_glm::vec3(3.0, 4.0, 3.0),
            nalgebra_glm::vec3(0.9, 0.4, 0.6),
            0.45,
            10.0,
            "Cube",
        ),
        (
            nalgebra_glm::vec3(0.0, 3.0, 6.0),
        ...
        (
            nalgebra_glm::vec3(-5.0, 5.5, 5.0),
            nalgebra_glm::vec3(0.4, 0.6, 0.9),
            0.25,
            3.0,
            "Sphere",
        ),
        (
            nalgebra_glm::vec3(5.0, 2.0, -3.0),
            nalgebra_glm::vec3(0.9, 0.5, 0.3),
            0.5,
            12.0,
            "Cylinder",
        ),
...
pub(super) fn spawn_healthbar(world: &mut World, position: Vec3) -> (Entity, Entity) {
    ...
    if let Some(transform) = world.core.get_local_transform_mut(background) {
        transform.translation =
            nalgebra_glm::vec3(position.x, position.y + bar_y_offset, position.z);

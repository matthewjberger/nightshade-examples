use crate::data::items::get_item_definition;
use crate::data::player::PlayerProgress;
use crate::data::skills::{SkillType, get_skill_definition};
...
fn draw_health_mana_bars(player_progress: &PlayerProgress, ctx: &egui::Context) {
    ...
    egui::Area::new(egui::Id::new("health_mana_bars"))
...
fn draw_stats_display(player_progress: &PlayerProgress, ctx: &egui::Context) {
    ...
    egui::Area::new(egui::Id::new("stats_display"))

...
pub fn spawn_weapon(world: &mut World, camera_entity: Entity) -> Entity {
    ...
    spawn_weapon_part(
        ...
        nalgebra_glm::vec3(0.025, 0.03, 0.08),
        "Cube",
        body_color.clone(),
    );
    spawn_weapon_part(
        world,
        root,
        nalgebra_glm::vec3(0.0, 0.005, -0.10),
        nalgebra_glm::vec3(0.012, 0.015, 0.12),
        "Cube",
        barrel_color.clone(),
    );
    spawn_weapon_part(
        world,
        root,
        nalgebra_glm::vec3(0.0, -0.02, 0.02),
        nalgebra_glm::vec3(0.015, 0.04, 0.025),
        "Cube",
        accent_color,
    );
    spawn_weapon_part(
        world,
        root,
        nalgebra_glm::vec3(0.0, 0.018, -0.03),
        nalgebra_glm::vec3(0.018, 0.005, 0.04),
        "Cube",
        body_color,
    );
    spawn_weapon_part(
        world,
        root,
        nalgebra_glm::vec3(0.0, 0.015, -0.06),
        nalgebra_glm::vec3(0.003, 0.01, 0.003),
        "Cube",
        barrel_color.clone(),
    );
    spawn_weapon_part(
        world,
        root,
        nalgebra_glm::vec3(0.0, 0.015, -0.08),
        nalgebra_glm::vec3(0.003, 0.008, 0.003),
        "Cube",
        barrel_color.clone(),
    );
    spawn_weapon_part(
        world,
        root,
        nalgebra_glm::vec3(0.0, 0.005, -0.20),

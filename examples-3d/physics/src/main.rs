...
use systems::{
    ...
    exhibits::{
        spawn_environment, spawn_exhibits, spawn_sun_overhead, update_coulomb_friction_joints,
        update_joint_visuals, update_prismatic_sliders, setup_velocity_friction_joints,
    },
    ...
    interaction::{
        ...
        update_drawers_momentum, update_lantern_light, update_levers_momentum,
        update_interaction_prompt, update_wheels_momentum,
    },
...
impl State for PhysicsGame {
    ...
    fn initialize(&mut self, world: &mut World) {
        ...
        #[cfg(feature = "openxr")]
        {
            ...
            self.game_world.resources.input_mode = ecs::InputMode::Xr;
        }
        ...
        #[cfg(feature = "openxr")]
        {
            let left_hand = systems::xr::spawn_hand_cube(world, nalgebra_glm::vec3(0.2, 0.6, 0.9));
            self.game_world.resources.left_hand_cube = Some(left_hand);
            let right_hand = systems::xr::spawn_hand_cube(world, nalgebra_glm::vec3(0.9, 0.6, 0.2));
            self.game_world.resources.right_hand_cube = Some(right_hand);
            systems::xr::spawn_bauble_gun(&mut self.game_world, world, right_hand);
        }
    ...
    fn run_systems(&mut self, world: &mut World) {
        ...
        #[cfg(feature = "openxr")]
        systems::xr::xr_hand_tracking_system(&mut self.game_world, world);

...
impl GfxShowcase {
    ...
    fn build_matrix_rain(&mut self, world: &mut World) {
        ...
        for column_index in 0..column_count {
            ...
            if let Some(sprite) = world.get_sprite_mut(head) {
                sprite.depth = 5.0;
            }
    ...
    fn update_starfield(&mut self, world: &mut World, delta_time: f32) {
        for (index, star) in self.stars.iter_mut().enumerate() {
            ...
            if let Some(sprite) = world.get_sprite_mut(self.scene_entities[index]) {
    ...
    fn build_galaxy(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(core) {
            sprite.depth = 4.0;
            sprite.blend_mode = SpriteBlendMode::Additive;
        }
    ...
    fn update_galaxy(&mut self, world: &mut World, delta_time: f32) {
        ...
        if core_index < self.scene_entities.len() {
            ...
            if let Some(sprite) = world.get_sprite_mut(self.scene_entities[core_index]) {
    ...
    fn build_lightning_storm(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(flash) {
            sprite.depth = 1.0;
            sprite.blend_mode = SpriteBlendMode::Additive;
        }
    ...
    fn spawn_lightning_bolt(&mut self, world: &mut World) {
        ...
        for segment in 0..segments {
            ...
            if hash_f32((self.time * 1000.0) as u32 + segment as u32 * 13 + 500) < 0.3 {
                ...
                if let Some(sprite) = world.get_sprite_mut(branch) {
                    sprite.depth = 10.0;
                    sprite.blend_mode = SpriteBlendMode::Additive;
                }
    ...
    fn update_fireworks(&mut self, world: &mut World, delta_time: f32) {
        ...
        if self.firework_timer <= 0.0 {
            ...
            world.set_sprite_particle_emitter(entity, emitter);
            ...
            if hash_f32((self.time * 100.0) as u32 + 3) < 0.4 {
                ...
                world.set_sprite_particle_emitter(secondary_entity, secondary_emitter);
    ...
    fn update_kaleidoscope(&mut self, world: &mut World) {
        ...
        for (primary_index, item) in self.kaleidoscope_items.iter().enumerate() {
            ...
            for mirror in 0..symmetry {
                ...
                if let Some(sprite) = world.get_sprite_mut(self.scene_entities[entity_index]) {
                    sprite.position = position;
    ...
    fn build_dna_helix(&mut self, world: &mut World) {
        ...
        for nucleotide_index in 0..HELIX_NUCLEOTIDE_COUNT {
            ...
            if let Some(sprite) = world.get_sprite_mut(strand1) {
        ...
        for nucleotide_index in 0..HELIX_NUCLEOTIDE_COUNT {
            ...
            if let Some(sprite) = world.get_sprite_mut(strand2) {
        ...
        for nucleotide_index in 0..HELIX_NUCLEOTIDE_COUNT {
            ...
            if let Some(sprite) = world.get_sprite_mut(rung) {
                sprite.depth = 4.5;
            }
        ...
        for nucleotide_index in 0..HELIX_NUCLEOTIDE_COUNT - 1 {
            ...
            if let Some(sprite) = world.get_sprite_mut(backbone1) {
                sprite.depth = 5.5;
                sprite.blend_mode = SpriteBlendMode::Additive;
            }
        ...
        for nucleotide_index in 0..HELIX_NUCLEOTIDE_COUNT - 1 {
            ...
            if let Some(sprite) = world.get_sprite_mut(backbone2) {
                sprite.depth = 5.5;
                sprite.blend_mode = SpriteBlendMode::Additive;
            }
    ...
    fn update_dna_helix(&mut self, world: &mut World) {
        ...
        for nucleotide_index in 0..HELIX_NUCLEOTIDE_COUNT {
            ...
            if let Some(sprite) =
                world.get_sprite_mut(self.scene_entities[strand1_start + nucleotide_index])
            {
            ...
            if let Some(sprite) =
                world.get_sprite_mut(self.scene_entities[strand2_start + nucleotide_index])
            {
            ...
            if let Some(sprite) =
                world.get_sprite_mut(self.scene_entities[rung_start + nucleotide_index])
            {
        ...
        for nucleotide_index in 0..HELIX_NUCLEOTIDE_COUNT - 1 {
            ...
            if let Some(sprite) =
                world.get_sprite_mut(self.scene_entities[backbone1_start + nucleotide_index])
            {
            ...
            if let Some(sprite) =
                world.get_sprite_mut(self.scene_entities[backbone2_start + nucleotide_index])
            {
    ...
    fn build_solar_system(&mut self, world: &mut World) {
        ...
        if let Some(sprite) = world.get_sprite_mut(sun) {
            sprite.depth = 3.0;
            sprite.blend_mode = SpriteBlendMode::Additive;
        }
        ...
        if let Some(sprite) = world.get_sprite_mut(sun_glow) {
            sprite.depth = 2.0;
            sprite.blend_mode = SpriteBlendMode::Additive;
        }
        ...
        for (planet_index, &(orbit_radius, _, _, _)) in planet_configs.iter().enumerate() {
            ...
            if let Some(sprite) = world.get_sprite_mut(ring) {
                sprite.depth = 1.0;
            }
            ...
            if let Some(sprite) = world.get_sprite_mut(planet) {
                sprite.depth = 6.0;
            }
            ...
            moon_configs.iter().enumerate()
        {
            ...
            if let Some(sprite) = world.get_sprite_mut(moon) {
                sprite.depth = 7.0;
            }
    ...
    fn update_solar_system(&mut self, world: &mut World, delta_time: f32) {
        ...
        if let Some(sprite) = world.get_sprite_mut(self.scene_entities[0]) {
            sprite.size = Vec2::new(50.0 * sun_pulse, 50.0 * sun_pulse);
        }
        let glow_pulse = 0.9 + 0.1 * (self.time * 0.6 + 1.0).sin();
        if let Some(sprite) = world.get_sprite_mut(self.scene_entities[1]) {
        ...
        for (moon_index, moon) in self.moons.iter_mut().enumerate() {
            ...
            if let Some(sprite) =
                world.get_sprite_mut(self.scene_entities[moon_entity_start + moon_index])
            {
    ...
    fn build_stencil_windows(&mut self, world: &mut World) {
        ...
        for index in 0..mask_count {
            ...
            if let Some(sprite) = world.get_sprite_mut(mask_entity) {
                sprite.depth = 3.0;
            ...
            if let Some(sprite) = world.get_sprite_mut(border) {
                sprite.depth = 6.0;
            }
    ...
    fn update_stencil_windows(&mut self, world: &mut World, delta_time: f32) {
        ...
        for (index, mask) in self.stencil_masks.iter_mut().enumerate() {
            ...
            if let Some(sprite) = world.get_sprite_mut(self.scene_entities[mask_entity_index]) {
                sprite.position = position;
            }
            if let Some(sprite) = world.get_sprite_mut(self.scene_entities[border_entity_index]) {
                sprite.position = position;
            }
        }
    }
    ...
    fn build_shadow_theater(&mut self, world: &mut World) {
        ...
        for index in 0..item_count {
            ...
            if let Some(sprite) = world.get_sprite_mut(shadow_entity) {
            ...
            if let Some(sprite) = world.get_sprite_mut(shape_entity) {
        ...
        for index in 0..4 {
            ...
            if let Some(sprite) = world.get_sprite_mut(glow_entity) {
    ...
    fn update_shadow_theater(&mut self, world: &mut World, delta_time: f32) {
        for (index, item) in self.shadow_items.iter_mut().enumerate() {
            ...
            if let Some(sprite) = world.get_sprite_mut(self.scene_entities[shape_index]) {
            ...
            if let Some(shadow) = world.get_sprite_mut(self.scene_entities[shadow_index]) {
        ...
        for glow_index in 0..4 {
            ...
            if entity_index < self.scene_entities.len()
                && let Some(sprite) = world.get_sprite_mut(self.scene_entities[entity_index])
            {

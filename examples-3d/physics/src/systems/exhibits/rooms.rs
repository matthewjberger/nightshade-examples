...
pub(super) fn spawn_curiosity_room(game_world: &mut GameWorld, world: &mut World, center: Vec3) {
    let room_height = 3.0;
    ...
    let crystal_material = create_textured_material(nalgebra_glm::vec3(0.2, 0.4, 0.9), 0.15, 0.7);
    ...
    let trinket_material = create_textured_material(nalgebra_glm::vec3(0.6, 0.5, 0.35), 0.7, 0.0);
    ...
    let emerald_material = create_textured_material(nalgebra_glm::vec3(0.1, 0.7, 0.3), 0.2, 0.6);
...
pub(super) fn spawn_workshop_room(game_world: &mut GameWorld, world: &mut World, center: Vec3) {
    let room_height = 3.0;
    ...
    let bench_material = create_textured_material(nalgebra_glm::vec3(0.35, 0.28, 0.18), 0.8, 0.05);
    let bench_y = 0.8;
    ...
    let metal_material = create_textured_material(nalgebra_glm::vec3(0.5, 0.5, 0.55), 0.3, 0.85);
    let tool_configs = [
        (
    ...
    let brick_material = create_textured_material(nalgebra_glm::vec3(0.65, 0.25, 0.2), 0.85, 0.0);
    let brick_size = 0.15;
    let brick_positions = [

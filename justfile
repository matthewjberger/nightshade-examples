...
lint-wasm:
    cargo clippy --workspace --target wasm32-unknown-unknown --exclude multiplayer_pong --exclude steam --exclude benchmark --exclude text_adventure --exclude terminal_breakout -- -D warnings
